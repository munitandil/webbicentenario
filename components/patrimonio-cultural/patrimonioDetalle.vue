                            ...
                            <div class="single_post animation" data-animation="fadeInUp " data-animation-delay="0.1s">
                                <div class="dsi-list-image-post-detail mb-md-5 mb-4" v-if="listImages">
                                    <no-ssr>
                                        ...
                                        <carousel v-if="listImages" :autoplay="false" :items="1" :nav="true"
                                            :loop="true" :dots="true" :responsive="{
                                              0: { items: 1, nav: true },
                                              600: { items: 1, nav: true },
                                            }">
                                            <img :src="item" alt="image222" v-for="item in listImages.split('|#|')"
                                                :key="item" />
                                        </carousel>
                                    </no-ssr>
                                </div>
                                        ...
                                        <!-- <div class="dsi-descargas-novedades light_gray_bg" v-if="getDetalleNovedad.doc">
                                            ...
                                            <ul>
                                                <li v-for="item in getDetalleNovedad.doc.split('|#|')" :key="item">
                                                    <DSILink pCustomLabel=" " :pCustomLink="item" pTipoLink="E"
                                                        pTitle="Descargar archivo">
                                                        <i class="icon icon-file-pdf"
                                                            v-if="item.split('.').pop() === 'pdf'"></i>
                                                        <i class="icon icon-file-word"
                                                            v-else-if="item.split('.').pop() === 'doc'"></i>
                                                    ...
                                                    <div class="tags" v-if="getDetalleNovedad.l_tag">
                                                        <DSILink v-for="item in getDetalleNovedad.l_tag.split(
                                                          '|#|'
                                                            ...
                                                            pTipoLink="I" :key="item.tag" :pTitle="item">
                                                            {{ item }}
                                                        </DSILink>
                                                    </div>
                                                </div>
