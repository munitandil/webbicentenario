<template>
  <div>
    <BannerPage
      ...
      :title="
        getDetalleNovedad ? getDetalleNovedad.titulo : 'Detalle de Programa'
      "
                        ...
                        <div class="col-md-8 mb-3 mb-md-0">
                          <div class="tags" v-if="getDetalleNovedad.l_tag">
                            <DSILink
                              ...
                              pCustomLabel=" "
                              :pCustomLink="'/tag?tipo=PROGRAMAS&tag=' + item"
                              pTipoLink="I"
                              :key="item.tag"
                              :pTitle="item"
                            >
  ...
  data() {
    return {
      ...
      sharing: {
       ...
       url: "http://localhost:3000/programas",
        title: "Muncinipalidad de Tandil - Novedades",
        description: "Listados de Programas",
    ...
    f_searchDetalle: function (id) {
      this.$store
        ...
        .then((res) => {
          ...
          this.titlePage = "titulo del programa " + detalle.titulo;
          this.metaDescription = "Detalle del Programa: " + detalle.titulo;
          this.metaKeywords = "";
        ...
        .catch((error) => {
          ...
          this.$nuxt.error({
            statusCode: 302,
            message:
              "Ocurrio un error al recuperar el detalle del programa: " +
              id +
              ". Error: " +
              error,
          });
