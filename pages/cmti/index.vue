<template>
  <div>
    <Header />
    <BannerPage :beadcrumb="beadcrumbPage" :title="'Consejo Municipal de Teatro Independiente'"></BannerPage>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-lg-9">
...
import CardDestacada from "@/components/cmti/cardDestacada.vue";
import Header from "@/components/Header";
import { mapGetters } from "vuex";
export default {
  components: { Sidebar, BannerPage, CardDestacada, Header },
  head: {
    title: "Cultura Municipalidad de Tandil - C.M.T.I",
    meta: [
      {
        hid: "description",
        name: "description",
        content: "Listados de novedades de ...",
      },
    ],
  },
  created() {
  ...
  computed: {
    ...mapGetters({
      getAllPosts: "posts/getPostscmit",
    }),
  },
  data() {
    return {
