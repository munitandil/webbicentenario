<template>
  <div>
    <Header />
    <BannerPage :beadcrumb="beadcrumbPage" :title="'Programas Educación'"></BannerPage>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-lg-9">
...
export default {
  ...
  head: {
    title: "Cultura Municipalidad de Tandil - Programas Educación",
    meta: [
      {
        hid: "description",
        name: "description",
        content: "Listados de  Programas Educativos que ocurren en el partido de Tandil",
      },
    ],
  },
  created() {
  ...
  computed: {
    ...mapGetters({
      getAllPosts: "posts/getPostsStandoute",
    }),
  },
  data() {
    return {
