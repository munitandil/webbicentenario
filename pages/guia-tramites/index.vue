...
<script>
import GuiaTramites from "@/components/guia-tramites/index.vue";
import Header from "@/components/Header";

export default {
  components: { GuiaTramites, Header },
  head: {
    title: "Municipalidad de Tandil - Guía de Trámites",
    meta: [
      {
        hid: "description",
        name: "description",
        content: "Guía de Trámites que se realizan en el municipio de Tandil",
      },
    ],
  },
